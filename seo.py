...
_S = {
    ...
    "updates_page.description": {"fr": "Les fonctions ajoutées à AubePilot mois par mois : carte et météo, fiches pilotes, langues, recherche, écoles, devis. Du plus récent au plus ancien.", "en": "Features added to AubePilot month by month: map and weather, pilot pages, languages, search, schools, quotes. Newest first.", "es": "Las funciones añadidas a AubePilot mes a mes: mapa y meteorología, fichas de piloto, idiomas, búsqueda, escuelas, presupuestos. De la más reciente a la más antigua.", "ru": "Функции, добавленные в AubePilot месяц за месяцем: карта и погода, профили пилотов, языки, поиск, школы, расчёты. От новых к старым.", "hi": "AubePilot में महीने-दर-महीने जोड़ी गई सुविधाएँ: नक्शा और मौसम, पायलट प्रोफ़ाइल, भाषाएँ, खोज, स्कूल, कोटेशन। सबसे नई पहले।", "uk": "Функції, додані до AubePilot місяць за місяцем: карта й погода, профілі пілотів, мови, пошук, школи, кошториси. Від найновіших.", "tr": "AubePilot'a ay ay eklenen özellikler: harita ve hava durumu, pilot profilleri, diller, arama, okullar, teklifler. En yeniden en eskiye.", "ur": "AubePilot میں مہینہ بہ مہینہ شامل کی گئی سہولتیں: نقشہ اور موسم، پائلٹ پروفائلز، زبانیں، تلاش، اسکول، کوٹیشن۔ سب سے نئی پہلے۔", "bn": "AubePilot-এ মাসে মাসে যোগ করা ফিচার: মানচিত্র ও আবহাওয়া, পাইলট প্রোফাইল, ভাষা, অনুসন্ধান, স্কুল, কোটেশন। নতুন থেকে পুরোনো।"},

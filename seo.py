...
_S = {
    ...
    "part107_page.title": {"fr": "Pilotes de drone Part 107 aux États-Unis — brevet FAA vérifié | AubePilot", "en": "Part 107 Drone Pilots for Hire in the United States — FAA-verified | AubePilot", "es": "Pilotos de drones Part 107 en Estados Unidos — licencia FAA verificada | AubePilot", "ru": "Пилоты дронов Part 107 в США — проверенный сертификат FAA | AubePilot", "hi": "संयुक्त राज्य में Part 107 ड्रोन पायलट — FAA-सत्यापित | AubePilot", "uk": "Пілоти дронів Part 107 у США — перевірений сертифікат FAA | AubePilot", "tr": "ABD'de Part 107 drone pilotları — FAA doğrulamalı | AubePilot", "ur": "امریکہ میں Part 107 ڈرون پائلٹس — FAA تصدیق شدہ | AubePilot", "bn": "যুক্তরাষ্ট্রে Part 107 ড্রোন পাইলট — FAA-যাচাইকৃত | AubePilot"},
    "part107_page.description": {"fr": "Trouvez un pilote de drone certifié FAA Part 107 par code ZIP, comparez les devis, ou inscrivez votre brevet : vérifié dans le registre FAA, affiché en badge, visible dans le monde entier.", "en": "Find an FAA Part 107 certified drone pilot by ZIP code and compare quotes, or list your certificate: checked against the FAA registry, shown as a badge, visible worldwide.", "es": "Encuentre un piloto de drones certificado FAA Part 107 por código ZIP y compare presupuestos, o inscriba su licencia: verificada en el registro FAA, mostrada como insignia, visible en todo el mundo.", "ru": "Найдите пилота дрона с сертификатом FAA Part 107 по ZIP-коду и сравните расчёты, или разместите свой сертификат: проверен в реестре FAA, отмечен значком, виден по всему миру.", "hi": "ZIP कोड से FAA Part 107 प्रमाणित ड्रोन पायलट खोजें और कोटेशन तुलना करें, या अपना प्रमाणपत्र सूचीबद्ध करें: FAA रजिस्ट्री में जाँचा, बैज के रूप में दिखाया, दुनिया भर में दृश्य।", "uk": "Знайдіть пілота дрона з сертифікатом FAA Part 107 за ZIP-кодом і порівняйте кошториси, або розмістіть свій сертифікат: перевірений у реєстрі FAA, показаний значком, видимий у всьому світі.", "tr": "ZIP koduyla FAA Part 107 sertifikalı drone pilotu bulun ve teklifleri karşılaştırın ya da sertifikanızı ekleyin: FAA kayıtlarında doğrulanır, rozet olarak gösterilir, tüm dünyada görünür.", "ur": "ZIP کوڈ سے FAA Part 107 سرٹیفائیڈ ڈرون پائلٹ تلاش کریں اور کوٹیشن موازنہ کریں، یا اپنا سرٹیفکیٹ درج کریں: FAA رجسٹری میں جانچا، بیج کے طور پر دکھایا، دنیا بھر میں نظر آنے والا۔", "bn": "ZIP কোড দিয়ে FAA Part 107 সার্টিফায়েড ড্রোন পাইলট খুঁজুন ও কোটেশন তুলনা করুন, বা আপনার সার্টিফিকেট তালিকাভুক্ত করুন: FAA রেজিস্ট্রিতে যাচাই, ব্যাজ হিসেবে প্রদর্শিত, বিশ্বজুড়ে দৃশ্যমান।"},
    "updates_page.title": {"fr": "Nouveautés — ce qui a changé pour les pilotes et les clients | AubePilot", "en": "What's new — changes for pilots and clients | AubePilot", "es": "Novedades — lo que cambió para pilotos y clientes | AubePilot", "ru": "Что нового — изменения для пилотов и клиентов | AubePilot", "hi": "नया क्या है — पायलटों और ग्राहकों के लिए बदलाव | AubePilot", "uk": "Що нового — зміни для пілотів і клієнтів | AubePilot", "tr": "Yenilikler — pilotlar ve müşteriler için değişiklikler | AubePilot", "ur": "نیا کیا ہے — پائلٹس اور کلائنٹس کے لیے تبدیلیاں | AubePilot", "bn": "নতুন কী — পাইলট ও ক্লায়েন্টদের জন্য পরিবর্তন | AubePilot"},
    "updates_page.description": {"fr": "Les fonctions ajoutées à AubePilot mois par mois : carte, fiches pilotes, langues, recherche, écoles, devis. Du plus récent au plus ancien.", "en": "Features added to AubePilot month by month: map, pilot pages, languages, search, schools, quotes. Newest first.", "es": "Las funciones añadidas a AubePilot mes a mes: mapa, fichas de piloto, idiomas, búsqueda, escuelas, presupuestos. De la más reciente a la más antigua.", "ru": "Функции, добавленные в AubePilot месяц за месяцем: карта, профили пилотов, языки, поиск, школы, расчёты. От новых к старым.", "hi": "AubePilot में महीने-दर-महीने जोड़ी गई सुविधाएँ: नक्शा, पायलट प्रोफ़ाइल, भाषाएँ, खोज, स्कूल, कोटेशन। सबसे नई पहले।", "uk": "Функції, додані до AubePilot місяць за місяцем: карта, профілі пілотів, мови, пошук, школи, кошториси. Від найновіших.", "tr": "AubePilot'a ay ay eklenen özellikler: harita, pilot profilleri, diller, arama, okullar, teklifler. En yeniden en eskiye.", "ur": "AubePilot میں مہینہ بہ مہینہ شامل کی گئی سہولتیں: نقشہ، پائلٹ پروفائلز، زبانیں، تلاش، اسکول، کوٹیشن۔ سب سے نئی پہلے۔", "bn": "AubePilot-এ মাসে মাসে যোগ করা ফিচার: মানচিত্র, পাইলট প্রোফাইল, ভাষা, অনুসন্ধান, স্কুল, কোটেশন। নতুন থেকে পুরোনো।"},
    "opportunities_page.title": {"fr": "Appels d'offres et contrats drone au Canada | AubePilot", "en": "Drone tenders and contracts in Canada | AubePilot", "es": "Licitaciones y contratos de dron en Canadá | AubePilot", "ru": "Тендеры и контракты для дронов в Канаде | AubePilot", "hi": "कनाडा में ड्रोन निविदाएँ और अनुबंध | AubePilot", "uk": "Тендери та контракти для дронів у Канаді | AubePilot", "tr": "Kanada'da drone ihaleleri ve sözleşmeleri | AubePilot", "ur": "کینیڈا میں ڈرون ٹینڈرز اور معاہدے | AubePilot", "bn": "কানাডায় ড্রোন দরপত্র ও চুক্তি | AubePilot"},
    "opportunities_page.description": {"fr": "Les appels d'offres publics pour pilotes de drone, LiDAR, photogrammétrie et inspection, classés par province, avec la date de clôture et le lien vers l'avis. Gratuit, mis à jour chaque nuit.", "en": "Public tenders for drone pilots, LiDAR, photogrammetry and inspection, by province, with closing date and a link to the notice. Free, updated nightly.", "es": "Licitaciones públicas para pilotos de dron, LiDAR, fotogrametría e inspección, por provincia, con fecha de cierre y enlace. Gratis, actualizado cada noche.", "ru": "Гостендеры для пилотов дронов, LiDAR, фотограмметрии и инспекции, по провинциям, с датой закрытия и ссылкой на объявление. Бесплатно, обновление каждую ночь.", "hi": "ड्रोन पायलट, LiDAR, फ़ोटोग्रामेट्री और निरीक्षण के लिए सार्वजनिक निविदाएँ, प्रांत के अनुसार, समापन तिथि और सूचना के लिंक के साथ। निःशुल्क, हर रात अद्यतन।", "uk": "Держтендери для пілотів дронів, LiDAR, фотограмметрії та інспекції, за провінціями, з датою закриття та посиланням. Безкоштовно, оновлення щоночі.", "tr": "Drone pilotları, LiDAR, fotogrametri ve denetim için kamu ihaleleri, eyalete göre, kapanış tarihi ve ilan bağlantısıyla. Ücretsiz, her gece güncellenir.", "ur": "ڈرون پائلٹس، LiDAR، فوٹوگرامیٹری اور انسپیکشن کے لیے سرکاری ٹینڈرز، صوبے کے مطابق، آخری تاریخ اور نوٹس کے لنک کے ساتھ۔ مفت، ہر رات اپ ڈیٹ۔", "bn": "ড্রোন পাইলট, LiDAR, ফটোগ্রামেট্রি ও পরিদর্শনের জন্য সরকারি দরপত্র, প্রদেশ অনুযায়ী, শেষ তারিখ ও নোটিশের লিংকসহ। বিনামূল্যে, প্রতি রাতে হালনাগাদ।"},
    "jobs_page.title": {"fr": "Emplois drone : pilotes, télépilotes, techniciens | AubePilot", "en": "Drone jobs: pilots, remote pilots, technicians | AubePilot", "es": "Empleos de dron: pilotos, telepilotos, técnicos | AubePilot", "ru": "Вакансии в сфере дронов: пилоты, операторы, техники | AubePilot", "hi": "ड्रोन नौकरियाँ: पायलट, रिमोट पायलट, तकनीशियन | AubePilot", "uk": "Вакансії у сфері дронів: пілоти, оператори, техніки | AubePilot", "tr": "Drone iş ilanları: pilotlar, uzaktan pilotlar, teknisyenler | AubePilot", "ur": "ڈرون ملازمتیں: پائلٹ، ریموٹ پائلٹ، ٹیکنیشن | AubePilot", "bn": "ড্রোন চাকরি: পাইলট, রিমোট পাইলট, টেকনিশিয়ান | AubePilot"},
    "jobs_page.description": {"fr": "Les offres d'emploi pour pilotes et techniciens de drone, reprises chaque nuit des services publics de l'emploi et d'API officielles, par pays et par province, avec le lien vers l'offre. Gratuit.", "en": "Job offers for drone pilots and technicians, collected nightly from public employment services and official APIs, by country and province, with a link to the posting. Free.", "es": "Ofertas de empleo para pilotos y técnicos de dron, recogidas cada noche de los servicios públicos de empleo y API oficiales, por país y provincia, con enlace a la oferta. Gratis.", "ru": "Вакансии для пилотов и техников дронов, ежедневно собираемые из государственных служб занятости и официальных API, по странам и регионам, со ссылкой на объявление. Бесплатно.", "hi": "ड्रोन पायलटों और तकनीशियनों के लिए नौकरी के प्रस्ताव, हर रात सार्वजनिक रोज़गार सेवाओं और आधिकारिक API से लिए गए, देश और प्रांत के अनुसार, विज्ञापन के लिंक के साथ। निःशुल्क।", "uk": "Вакансії для пілотів і техніків дронів, які щоночі збираються з державних служб зайнятості та офіційних API, за країнами та регіонами, з посиланням на оголошення. Безкоштовно.", "tr": "Drone pilotları ve teknisyenleri için iş ilanları, her gece kamu istihdam servislerinden ve resmi API'lerden alınır, ülkeye ve eyalete göre, ilan bağlantısıyla. Ücretsiz.", "ur": "ڈرون پائلٹس اور ٹیکنیشنز کے لیے ملازمت کی پیشکشیں، ہر رات سرکاری روزگار سروسز اور سرکاری API سے لی گئیں، ملک اور صوبے کے مطابق، اشتہار کے لنک کے ساتھ۔ مفت۔", "bn": "ড্রোন পাইলট ও টেকনিশিয়ানদের জন্য চাকরির প্রস্তাব, প্রতি রাতে সরকারি কর্মসংস্থান পরিষেবা ও অফিসিয়াল API থেকে সংগৃহীত, দেশ ও প্রদেশ অনুযায়ী, বিজ্ঞাপনের লিংকসহ। বিনামূল্যে।"},
    ...
    "partners_page.title": {"fr": "Nos partenaires | AubePilot", "en": "Our partners | AubePilot", "es": "Nuestros socios | AubePilot", "ru": "Наши партнёры | AubePilot", "hi": "हमारे साझेदार | AubePilot", "uk": "Наші партнери | AubePilot", "tr": "Ortaklarımız | AubePilot", "ur": "ہمارے شراکت دار | AubePilot", "bn": "আমাদের অংশীদার | AubePilot"},
    "partners_page.description": {"fr": "Écoles, assureurs, boutiques, associations et médias qui soutiennent le réseau AubePilot et ses pilotes de drone.", "en": "Schools, insurers, shops, associations and media that support the AubePilot network and its drone pilots.", "es": "Escuelas, aseguradoras, tiendas, asociaciones y medios que apoyan la red AubePilot y a sus pilotos de drones.", "ru": "Школы, страховщики, магазины, ассоциации и СМИ, которые поддерживают сеть AubePilot и её пилотов дронов.", "hi": "स्कूल, बीमाकर्ता, दुकानें, संघ और मीडिया जो AubePilot नेटवर्क और उसके ड्रोन पायलटों का समर्थन करते हैं।", "uk": "Школи, страховики, магазини, асоціації та медіа, що підтримують мережу AubePilot і її пілотів дронів.", "tr": "AubePilot ağını ve drone pilotlarını destekleyen okullar, sigortacılar, mağazalar, dernekler ve medya.", "ur": "اسکول، انشورنس کمپنیاں، دکانیں، انجمنیں اور میڈیا جو AubePilot نیٹ ورک اور اس کے ڈرون پائلٹس کی حمایت کرتے ہیں۔", "bn": "স্কুল, বীমাকারী, দোকান, সমিতি ও গণমাধ্যম যারা AubePilot নেটওয়ার্ক ও এর ড্রোন পাইলটদের সমর্থন করে।"},
...
PUBLIC_ROUTES = [
    ...
    ("/missions", "0.9", "daily"),
    ("/ecoles", "0.7", "weekly"),
    ("/opportunites", "0.8", "daily"),
    ("/emplois", "0.8", "daily"),
    ("/faq", "0.6", "monthly"),
    ("/nouveautes", "0.5", "weekly"),
    ("/part-107", "0.7", "weekly"),
    ("/contact", "0.5", "monthly"),
...
def updates_page(lang="fr"):
    return {"title": _s(lang, "updates_page.title"),
            "description": _s(lang, "updates_page.description")}


def part107_page(lang="fr"):
    return {"title": _s(lang, "part107_page.title"),
            "description": _s(lang, "part107_page.description")}


def opportunities_page(lang="fr"):
    return {"title": _s(lang, "opportunities_page.title"),
            "description": _s(lang, "opportunities_page.description")}


def jobs_page(lang="fr"):
    return {"title": _s(lang, "jobs_page.title"),
            "description": _s(lang, "jobs_page.description")}
...
def partners_page(lang="fr"):
    return {"title": _s(lang, "partners_page.title"),
            "description": _s(lang, "partners_page.description")}

...
_T = {
    ...
    "footer.eco_meta":    {"fr": "{year} · 15 services · auth partagée",
    ...
    "home.eyebrow":     {"fr": "Réseau pilote francophone — depuis 2026",
                         "en": "Francophone pilot network — since 2026"},
    ...
    "reg.bullet3":   {"fr": "Recherche géolocalisée dans la francophonie : France, Maghreb, Québec, Afrique de l'Ouest.",
                       "en": "Geo-located search across the francophonie: France, Maghreb, Quebec, West Africa."},

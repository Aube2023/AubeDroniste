...
def _inject_globals():
    return {
        ...
        "drone_capability_groups": DRONE_CAPABILITY_GROUPS,
        "cap_label": lambda c: DRONE_CAPABILITY_LABELS.get(c, c),
...
def _map_l10n() -> dict:
    ...
    return {
        ...
        "meteo": {
            ...
            "radarTime": t("meteo.radar_time", t="{t}"), "radarEmpty": t("meteo.radar_empty"),
            "radarError": t("meteo.radar_error"), "precip": t("meteo.precip", v="{v}"),
            "legend": t("meteo.legend"),

...
# Connexion automatique (case cochee par defaut a la connexion) : 30 jours,
# prolonges a chaque visite (glissant : seul un mois sans aucune visite
# redemande le mot de passe ; un an jugé trop long par le user le 2026-09-20,
# 14 j = Django/GitHub, 30 j = « se souvenir de moi » usuel). Sans la case :
# la session tombe avec le navigateur (cookie sans duree) et expire en base
# apres SESSION_SHORT_HOURS d'inactivite.
...
# Pays mis EN TETE des listes (marches principaux) : on garde le choix rapide
# pour la majorite des inscrits, sans limiter les autres. « Québec » a ete
# retire : c'est une province, pas un pays.
FEATURED_COUNTRIES = [
    "Canada", "France", "Belgique", "Suisse", "États-Unis", "Luxembourg",
    "Maroc", "Algérie", "Tunisie", "Sénégal", "Côte d'Ivoire",
]

# Liste COMPLETE des pays (francais, ordre alphabetique). Un pilote ou un client
# peut venir de n'importe ou : la liste doit etre exhaustive, sinon il ne peut
# pas s'inscrire correctement (et n'apparait pas sur la carte).
COUNTRIES = [
    ...
    "Comores", "Congo", "Congo (RDC)", "Corée du Nord", "Corée du Sud",
    ...
    "Guyana", "Haïti", "Honduras", "Hongrie", "Îles Marshall", "Îles Salomon",
